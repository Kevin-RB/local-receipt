...
- Same-box backups share a failure domain with the app until off-site storage ships; that risk is accepted while the pipeline is unproven. (Superseded — the backup container was removed; see the 2026-09-08 update above.)
